...
EOF
 ...
 for month in 01 03 05 07 08 10 12; do
   for day in {01..31}; do
     ...
     fils = systemfunc("ls /global/cscratch1/sd/laart/getdata_daily_${var_small}/PRISM_${var_small}_stable_4kmD2_${year}${month}${day}_bil.bil")
